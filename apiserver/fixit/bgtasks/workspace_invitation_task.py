...
# Module imports
from fixit.db.models import User, Workspace, WorkspaceMemberInvite
from fixit.license.utils.instance_value import get_email_configuration
...
def workspace_invitation(email, workspace_id, token, current_site, invitor):
    try:
        ...
        subject = f"{user.first_name or user.display_name or user.email} has invited you to join them in {workspace.name} on Fixit"
        ...
        msg.send()
        logging.getLogger("fixit").info("Email sent succesfully")
