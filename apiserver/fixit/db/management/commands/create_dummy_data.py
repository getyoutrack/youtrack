...
# Module imports
from fixit.db.models import User, Workspace, WorkspaceMember
    ...
    def handle(self, *args: Any, **options: Any) -> str | None:
        ...
        try:
            ...
            if (
                ...
                raise CommandError(
                    "User email is required and should have signed in fixit"
                )
            ...
            for i in range(project_count):
                ...
                from fixit.bgtasks.dummy_data_task import create_dummy_data
