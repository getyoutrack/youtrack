...
import fixit.db.models.api
import fixit.db.models.webhook
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.URLField(
                        validators=[
                            fixit.db.models.webhook.validate_schema,
                            fixit.db.models.webhook.validate_domain,
                        ]
                    ),
                ),
                ...
                (
                    "secret_key",
                    models.CharField(
                        default=fixit.db.models.webhook.generate_token,
                        max_length=255,
                    ),
                ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                db_index=True,
                default=fixit.db.models.api.generate_token,
                max_length=255,
                unique=True,
            ),
        ),
