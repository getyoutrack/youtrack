...
from fixit.license.api.permissions import InstanceAdminPermission
from fixit.license.models import InstanceConfiguration
from fixit.license.api.serializers import InstanceConfigurationSerializer
from fixit.license.utils.encryption import encrypt_data
from fixit.utils.cache import cache_response, invalidate_cache
from fixit.license.utils.instance_value import (
...
class EmailCredentialCheckEndpoint(BaseAPIView):
    ...
    def post(self, request):
        ...
        subject = "Email Notification from Fixit"
        message = (
            "This is a sample email notification sent from Fixit application."
        )
        # Send the email
        try:
