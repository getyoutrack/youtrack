...
service_name = os.environ.get("SERVICE_NAME", "fixit-ce-api")
resource = Resource.create({"service.name": service_name})
trace.set_tracer_provider(TracerProvider(resource=resource))
# Configure the OTLP exporter
otel_endpoint = os.environ.get("OTLP_ENDPOINT", "https://telemetry.fixit.so")
...
MIDDLEWARE = [
    ...
    "fixit.authentication.middleware.session.SessionMiddleware",
    ...
    "fixit.middleware.api_log_middleware.APITokenLogMiddleware",
]
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "fixit.authentication.adapter.exception.auth_exception_handler",
}
...
STORAGES["default"] = {
    "BACKEND": "fixit.settings.storage.S3Storage",
}
...
CELERY_IMPORTS = (
    # scheduled tasks
    "fixit.bgtasks.issue_automation_task",
    "fixit.bgtasks.exporter_expired_task",
    "fixit.bgtasks.file_asset_task",
    "fixit.bgtasks.email_notification_task",
    "fixit.bgtasks.api_logs_task",
    "fixit.license.bgtasks.tracer",
    # management tasks
    "fixit.bgtasks.dummy_data_task",
)
...
SESSION_ENGINE = "fixit.db.models.session"
...
CSRF_FAILURE_VIEW = "fixit.authentication.views.common.csrf_failure"
