...
from youtrack.app.serializers import IssueActivitySerializer
from youtrack.bgtasks.notification_task import notifications
...
from youtrack.bgtasks.webhook_task import webhook_activity
    ...
    if current_instance.get("archived_at") != requested_data.get(
        ...
        if requested_data.get("archived_at") is None:
            ...
            if requested_data.get("automation"):
                comment = "Youtrack has archived the issue"
                new_value = "archive"
            else:
    ...
    if requested_data.get("closed_to") is not None:
        ...
        issue_activities.append(
            IssueActivity(
                ...
                project_id=project_id,
                workspace_id=workspace_id,
                comment="Youtrack updated the state to ",
                old_identifier=None,
