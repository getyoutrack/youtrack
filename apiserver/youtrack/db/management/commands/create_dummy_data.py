...
# Module imports
from youtrack.db.models import User, Workspace, WorkspaceMember
    ...
    def handle(self, *args: Any, **options: Any) -> str | None:
        ...
        try:
            ...
            if (
                ...
                raise CommandError(
                    "User email is required and should have signed in youtrack"
                )
            ...
            for i in range(project_count):
                ...
                from youtrack.bgtasks.dummy_data_task import create_dummy_data
