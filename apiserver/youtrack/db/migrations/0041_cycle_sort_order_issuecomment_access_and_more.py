...
import youtrack.db.models.exporter
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "token",
                    models.CharField(
                        default=youtrack.db.models.exporter.generate_token,
                        max_length=255,
                        unique=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        default=youtrack.db.models.project.get_anchor,
                        max_length=255,
                        unique=True,
                    ),
                ),
                ...
                (
                    "views",
                    models.JSONField(
                        default=youtrack.db.models.project.get_default_views
                    ),
                ),
                (
                    "created_by",
