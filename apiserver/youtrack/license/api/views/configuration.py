...
from youtrack.license.api.permissions import InstanceAdminPermission
from youtrack.license.models import InstanceConfiguration
from youtrack.license.api.serializers import InstanceConfigurationSerializer
from youtrack.license.utils.encryption import encrypt_data
from youtrack.utils.cache import cache_response, invalidate_cache
from youtrack.license.utils.instance_value import (
...
class EmailCredentialCheckEndpoint(BaseAPIView):
    ...
    def post(self, request):
        ...
        subject = "Email Notification from Youtrack"
        message = (
            "This is a sample email notification sent from Youtrack application."
        )
        # Send the email
        try:
