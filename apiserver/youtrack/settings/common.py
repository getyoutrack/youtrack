...
service_name = os.environ.get("SERVICE_NAME", "youtrack-ce-api")
resource = Resource.create({"service.name": service_name})
trace.set_tracer_provider(TracerProvider(resource=resource))
# Configure the OTLP exporter
otel_endpoint = os.environ.get("OTLP_ENDPOINT", "https://telemetry.youtrack.so")
...
MIDDLEWARE = [
    ...
    "youtrack.authentication.middleware.session.SessionMiddleware",
    ...
    "youtrack.middleware.api_log_middleware.APITokenLogMiddleware",
]
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "youtrack.authentication.adapter.exception.auth_exception_handler",
}
...
WSGI_APPLICATION = "youtrack.wsgi.application"
ASGI_APPLICATION = "youtrack.asgi.application"
...
STORAGES["default"] = {
    "BACKEND": "youtrack.settings.storage.S3Storage",
}
...
CELERY_IMPORTS = (
    # scheduled tasks
    "youtrack.bgtasks.issue_automation_task",
    "youtrack.bgtasks.exporter_expired_task",
    "youtrack.bgtasks.file_asset_task",
    "youtrack.bgtasks.email_notification_task",
    "youtrack.bgtasks.api_logs_task",
    "youtrack.license.bgtasks.tracer",
    # management tasks
    "youtrack.bgtasks.dummy_data_task",
)
...
SESSION_ENGINE = "youtrack.db.models.session"
...
CSRF_FAILURE_VIEW = "youtrack.authentication.views.common.csrf_failure"
